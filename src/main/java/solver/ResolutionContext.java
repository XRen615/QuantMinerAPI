...
// Yang !!!! The most important class  - // Class to memorize a set of parameters to maintain throughout the resolution process
                    ...
                    try {
                        ...
                        if (fluxFichier.readByte() == 1) {
                            ...
                            for (iIndiceItem=0; iIndiceItem<iNombreItems; iIndiceItem++) {
                                ...
                                int xx = (int)fluxFichier.readByte();
                                boolean yy = ((int)fluxFichier.readByte() == 1);
